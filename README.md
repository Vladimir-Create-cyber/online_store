...
Современный интернет-магазин на Laravel 12 с пользовательской и административной частями, заказами, уведомлениями, отзывами и аналитикой.
...
- **Дашборд**: визуализация статистики с помощью Chart.js.
