...
$_['text_login_for_view_price'] = 'Оптовые цены доступны только для зарегистрированных пользователей';
...
$_['text_public_offer']     = 'Нажимая кнопку "Зарегистрироваться", вы принимаете условия<br> <a href="publichnoj-oferti">Публичной оферты</a>';
