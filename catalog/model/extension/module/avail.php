...
class ModelExtensionModuleAvail extends Model {
    ...
    public function addMail($data) {
        ...
        $this->db->query("INSERT INTO " . DB_PREFIX . "avail SET email = '" .  $data['email'] . "', product = '" .  $data['product'] . "', arbitrary_fields = '" .  $data['arbitrary_fields'] . "', logged_id = '" .  $data['logged_id'] . "', product_id = '" .  $data['product_id'] . "', desired_quantity = '" .  $data['desired_quantity'] . "', price = '" .  $price . "', name = '" .  $data['name'] . "', comment = '" .  $data['comment'] . "', status = '" .  $data['status'] . "', link_page = '" . $data['href'] . "', language_id = '" . $data['language_id'] . "'");
