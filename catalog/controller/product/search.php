	...
	public function index() {
	 ...
	 //    }
		...
		$data['isLogin'] = $this->customer->isLogged();
			...
			if (isset($this->session->data['payment_address']['country_id']) && $this->session->data['payment_address']['country_id'] == 170) {
	    		$data['puck'] = 'brutto';
	    	} else {
	    		$data['puck'] = 'netto';
	    	}
		...
		$data['text_limit'] = $this->language->get('text_limit');
			...
			// krumax edit
			$data['text_login_for_view_price'] = $this->language->get('text_login_for_view_price');
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			foreach ($results as $result) {
				...
				if (isset($string[2])) {
					...
					$name1 = $string[0];
					$name2 = (isset($string[1]) ? $string[1] : '');

				}

				$man_category_id = $this->model_catalog_category->getCategoryIdByName($result['manufacturer']);

				$mhref = $this->url->link('product/category', 'category_id=' . $man_category_id);
