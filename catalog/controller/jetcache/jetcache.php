...
EOF;
		...
		public function jetcache_minify_css_after_gps($output) {
			...
			if (isset($this->http_user_agent) && (strpos(strtolower($this->http_user_agent), 'lighthouse') !== false || strpos(strtolower($this->http_user_agent), 'google page speed') !== false)) {
				...
				$preload_replace_in = array('type="text/jetcachecssgps" rel="stylesheet"', "type='text/jetcachecssgps' rel='stylesheet'", 'type="text/jetcachecssgps"', "type='text/jetcachecssgps'");
				$preload_replace_out = array('type="text/jetcachecss"', 'type="text/jetcachecss"', 'type="text/jetcachecss"', "type='text/jetcachecss'");
