	...
	public function index() {
		...
		if (php_sapi_name() === 'cli') return;
			...
			if(isset($this->request->get['_route_'])){
				...
				// 	if ($language['code'] == 'pl-pl') $lcode = 'pl';
				// 	if ($language['code'] == 'ru-ru') $lcode = 'ru';
				// 	if ($language['code'] == 'en-gb') $lcode = 'en-gb';
				// 	if ($language['code'] == 'es-es') $lcode = 'es';
				// 	if ($language['code'] == 'zh-CN') $lcode = 'ch';
